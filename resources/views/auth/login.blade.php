...
<head>
    ...
    <title>Login - {{ \App\Models\Setting::getVal('site_name', config('app.name', 'Bhagva')) }}</title>
    ...
    <div class="login-container">
        ...
        <div class="login-left">
            <div class="brand-content">
                <h1>{{ \App\Models\Setting::getVal('site_name', 'Bhagva') }}</h1>
                <p>Empowering the nation through transparency, dedication, and progress. Sign in to access your administrative dashboard.</p>
            </div>
        </div>
